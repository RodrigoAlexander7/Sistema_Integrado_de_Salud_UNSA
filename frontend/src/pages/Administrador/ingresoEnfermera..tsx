...
import { User, FileText, Phone, Mail, Activity } from "lucide-react";
import TitleCard from "@/components/TitleCard";

const RegistroEnfermera: React.FC = () => {
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                    ...
                    <div>
                        ...
                        <Input 
                            ...
                            onChange={handleChange}
                            placeholder="Nombres de la enfermera" 
                        />
                    </div>
                    <div>
                        ...
                        <Input 
                            ...
                            onChange={handleChange}
                            placeholder="Apellidos de la enfermera" 
                        />
                    </div>

                    {/* Número de Licencia */}
                    <div className="col-span-2">
                        <Label>Número de Licencia de Enfermería:</Label>
                    ...
                    <div>
                        ...
                        <div className="flex items-center">
                            ...
                            <Input 
                                ...
                                onChange={handleChange}
                                placeholder="Ej. enfermera@ejemplo.com" 
                            />
                        </div>
                    </div>
...
export default RegistroEnfermera;